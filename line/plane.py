...
p1 = Plane(normal_vector=Vector([Decimal('-0.412'), Decimal('3.806'), Decimal('0.728')]), constant_term=Decimal('-3.46'))
p2 = Plane(normal_vector=Vector([Decimal('-0.412'), Decimal('3.806'), Decimal('0.728')]), constant_term=Decimal('-3.46'))
